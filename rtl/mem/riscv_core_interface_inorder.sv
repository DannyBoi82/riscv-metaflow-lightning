...
`ifdef SIMULATION_18447
    ...
    /* Idealized I$ residency model (tb/icache_shadow.sv). Same instrument the
     * lightning wrapper carries; this core is its control group, since it only
     * cancels on a resolved mispredict. Inert unless built with
